...
class BaseTest(asynctest.TestCase):
    ...
    def setUp(self):
        patch = mock.patch(
            'buildhub.lambda_s3_event.kinto_http.Client.create_record'
        )
...
class FromArchiveFirefox(BaseTest):
    remote_content = {
        ...
        (
            'pub/firefox/candidates/51.0-candidates/build1/linux-x86_64/'
            'en-US/firefox-51.0.json'
        ): {
            'as': '$(CC)',
    ...
    async def test_from_rc_archive_before_metadata(self):
        event = fake_event(
            'pub/firefox/candidates/56.0b1-candidates/build5/mac-EME-free/'
    ...
    async def test_from_non_archive_files(self):
        event = fake_event(
            'pub/firefox/releases/54.0.1-funnelcake117/win32/en-US/'
    ...
    async def test_from_unknown_product(self):
        event = fake_event(
            'pub/calendar/releases/1.0b1/linux-x86_64/en-US/'
            'sunbird-1.0b1.tar.bz2'
        )
        await lambda_s3_event.main(self.loop, event)
    ...
    async def test_from_nightly_archive(self):
        event = fake_event(
            'pub/firefox/nightly/2017/08/2017-08-05-10-03-34-'
        ...
        self.mock_create_record.assert_called_with(
            ...
            data={
                ...
                'build': {
                    ...
                    'as': 'ml.exe',
                    'cc': (
                        'z:/build/build/src/vs2015u3/VC/bin/amd64_x86/cl.exe'
                    ),
                    'cxx': (
                        'z:/build/build/src/vs2015u3/VC/bin/amd64_x86/cl.exe'
                    ),
    ...
    async def test_from_rc_archive(self):
        event = fake_event(
            'pub/firefox/candidates/51.0-candidates/build1/linux-x86_64-EME'
            '-free/zh-TW/firefox-51.0.tar.bz2'
        )
        await lambda_s3_event.main(self.loop, event)
    ...
    async def test_from_sns_event(self):
        event = fake_sns_routed_event(
            'pub/firefox/releases/55.0/mac/ar/Firefox 55.0.dmg'
        )
        await lambda_s3_event.main(self.loop, event)
        assert not self.mock_create_record.called
...
class FromRCMetadataFirefox(BaseTest):
    remote_content = {
        ...
        (
            'pub/firefox/candidates/56.0b1-candidates/build4/'
            'linux-x86_64/en-US/'
        ): {
            'prefixes': [], 'files': [{
                'name': 'firefox-56.0b1.tar.bz2',
        ...
        'firefox-56.0b1.json': {
            ...
            'cc': (
                '/usr/bin/ccache /home/worker/workspace/build/src/gcc/bin/gcc '
                '-std=gnu99'
            ),
            'cxx': (
                '/usr/bin/ccache /home/worker/workspace/build/src/gcc/bin/g++ '
                '-std=gnu++11'
            ),
            'host_alias': 'x86_64-pc-linux-gnu',
            'host_cpu': 'x86_64',
        ...
        self.mock_create_record.assert_any_call(
            ...
            data={
                ...
                'build': {
                    ...
                    'as': '$(CC)',
                    'cc': (
                        '/usr/bin/ccache /home/worker/workspace/build/src/gcc/'
                        'bin/gcc -std=gnu99'
                    ),
                    'cxx': (
                        '/usr/bin/ccache /home/worker/workspace/build/src/gcc/'
...
class FromNightlyArchiveFirefox(BaseTest):
    ...
    async def test_from_nightly_archive_linux_metadata_missing(self):
        event = fake_event(
            'pub/firefox/nightly/2017/08/2017-08-05-10-03-34-mozilla-central'
            '-l10n/firefox-57.0a1.ru.linux-x86_64.tar.bz2'
        )
        await lambda_s3_event.main(self.loop, event)
...
class FromNightlyMetadataFirefox(BaseTest):
    remote_content = {
        ...
        'firefox-57.0a1.en-US.mac.json': {
            ...
            'buildid': '20170805100334',
            'cc': (
                '/usr/bin/ccache /home/worker/workspace/build/src/clang/bin/'
                'clang -target x86_64-apple-darwin11 -B /home/worker/'
                'workspace/build/src/cctools/bin -isysroot /home/worker/'
                'workspace/build/src/MacOSX10.7.sdk -std=gnu99'
            ),
            'cxx': (
                '/usr/bin/ccache /home/worker/workspace/build/src/clang/bin/'
                'clang++ -target x86_64-apple-darwin11 -B /home/worker/'
                'workspace/build/src/cctools/bin -isysroot /home/worker/'
                'workspace/build/src/MacOSX10.7.sdk -std=gnu++11'
            ),
            'host_alias': 'x86_64-pc-linux-gnu',
            'host_cpu': 'x86_64',
            'host_os': 'linux-gnu',
    ...
    async def test_from_nightly_date_is_ignored(self):
        event = fake_event(
            'firefox/nightly/2017/08/2017-08-01-15-03-43-date/'
    ...
    async def test_from_nightly_metadata_linux(self):
        ...
        self.mock_create_record.assert_any_call(
            ...
            data={
                'id': (
                    'firefox_nightly_2017-08-05-10-03-34_57-0a1_linux-'
                    'x86_64_en-us'
                ),
                'source': {
                    'product': 'firefox',
    ...
    async def test_from_nightly_metadata_mac(self):
        ...
        self.mock_create_record.assert_called_with(
            ...
            data={
                'id': (
                    'firefox_nightly_2017-08-05-10-03-34_57-0a1_macosx_en-us'
                ),
                'source': {
                    'product': 'firefox',
                    'revision': '933a04a91ce3bd44b230937083a835cb60637084',
                ...
                'build': {
                    ...
                    'date': '2017-08-05T10:03:34Z',
                    'cc': (
                        '/usr/bin/ccache /home/worker/workspace/build/src/'
                        'clang/bin/clang -target x86_64-apple-darwin11 -B '
                        '/home/worker/workspace/build/src/cctools/bin '
                        '-isysroot /home/worker/workspace/build/src/'
                        'MacOSX10.7.sdk -std=gnu99'
                    ),
                    'cxx': (
                        '/usr/bin/ccache /home/worker/workspace/build/src/'
                        'clang/bin/clang++ -target x86_64-apple-darwin11 -B '
...
class FromArchiveAndroid(BaseTest):
    remote_content = {
        ...
        'fennec-55.0.en-US.android-i386.json': {
            ...
            'cc': (
                '/usr/bin/ccache /home/worker/workspace/build/src/android-ndk/'
                'toolchains/x86-4.9/prebuilt/linux-x86_64/bin/i686-linux-'
                'android-gcc -std=gnu99'
            ),
            'cxx': (
                '/usr/bin/ccache /home/worker/workspace/build/src/android-ndk/'
                'toolchains/x86-4.9/prebuilt/linux-x86_64/bin/i686-linux-'
                'android-g++ -std=gnu++11'
            ),
            'host_alias': 'x86_64-pc-linux-gnu',
            'host_cpu': 'x86_64',
            'host_os': 'linux-gnu',
        ...
        '-central-android-aarch64/fennec-57.0a1.multi.android-aarch64.json': {
            ...
            'cc': (
                ...
                'bin/aarch64-linux-android-gcc -std=gnu99'
            ),
            'cxx': (
                '/usr/bin/ccache /home/worker/workspace/build/src/android-ndk/'
                'toolchains/aarch64-linux-android-4.9/prebuilt/linux-x86_64/'
                'bin/aarch64-linux-android-g++ -std=gnu++11'
            ),
            'host_alias': 'x86_64-pc-linux-gnu',
            'host_cpu': 'x86_64',
            'host_os': 'linux-gnu',
        ...
        (
            ...
            'android-aarch64/en-US/fennec-57.0a1.en-US.android-aarch64.json'
        ): {
            'as': '$(CC)',
            'buildid': '20170809100339',
            'cc': (
        ...
        (
            'pub/mobile/nightly/2017/08/2017-08-09-10-03-39-mozilla-central-'
            'android-x86-old-id/fennec-57.0a1.multi.android-i386.json'
        ): {
            'as': '$(CC)',
            'buildid': '20170809100339',
            'cc': (
    ...
    async def test_from_release_archive_before_metadata(self):
        event = fake_event(
            'pub/mobile/releases/55.0/android-api-15/en-US/'
    ...
    async def test_from_release_archive_english(self):
        event = fake_event(
            'pub/mobile/releases/55.0/android-x86/en-US/'
        ...
        self.mock_create_record.assert_called_with(
            ...
            data={
                ...
                'build': {
                    ...
                    'cc': (
                        '/usr/bin/ccache /home/worker/workspace/build/src/'
                        'android-ndk/toolchains/x86-4.9/prebuilt/linux-x86_64/'
                        'bin/i686-linux-android-gcc -std=gnu99'
                    ),
                    'cxx': (
                        '/usr/bin/ccache /home/worker/workspace/build/src/'
                        'android-ndk/toolchains/x86-4.9/prebuilt/linux-x86_64/'
                        'bin/i686-linux-android-g++ -std=gnu++11'
                    ),
                    'host': 'x86_64-pc-linux-gnu',
    ...
    async def test_from_release_archive_multi(self):
        event = fake_event(
            'pub/mobile/releases/55.0/android-x86/multi/'
    ...
    async def test_from_nightly_archive_multi(self):
        ...
        self.mock_create_record.assert_called_with(
            ...
            data={
                'id': (
                    'fennec_nightly_2017-08-09-10-03-39_57-0a1_android-'
                    'aarch64_multi'
                ),
                'source': {
                    'product': 'fennec',
                ...
                'build': {
                    ...
                    'cc': (
                        '/usr/bin/ccache /home/worker/workspace/build/src/'
                        'android-ndk/toolchains/aarch64-linux-android-4.9/'
                    ...
                    'cxx': (
                        '/usr/bin/ccache /home/worker/workspace/build/src/'
                        'android-ndk/toolchains/aarch64-linux-android-4.9/'
                        'prebuilt/linux-x86_64/bin/aarch64-linux-android-'
                        'g++ -std=gnu++11'
                    ),
                    'host': 'x86_64-pc-linux-gnu',
    ...
    async def test_from_nightly_old_id(self):
        ...
        self.mock_create_record.assert_called_with(
            ...
            data={
                'id': (
                    'fennec_nightly-old-id_2017-08-09-10-03-39_57-0a1_'
                    'android-i386_multi'
                ),
                'source': {
                    'product': 'fennec',
                ...
                'build': {
                    ...
                    'cc': (
                        '/usr/bin/ccache /home/worker/workspace/build/src/'
                        'android-ndk/toolchains/x86-4.9/prebuilt/'
                        'linux-x86_64/bin/i686-linux-android-gcc -std=gnu99'
                    ),
                    'cxx': (
                        '/usr/bin/ccache /home/worker/workspace/build/src/'
                        'android-ndk/toolchains/x86-4.9/prebuilt/'
                        'linux-x86_64/bin/i686-linux-android-g++ -std=gnu++11'
                    ),
                    'host': 'x86_64-pc-linux-gnu',
                    'target': 'i386-pc-linux-android',
                },
    ...
    remote_content = {
        ...
        'fennec-56.0b1.en-US.android-arm.json': {
            ...
            'cc': (
                ...
                'bin/arm-linux-androideabi-gcc -std=gnu99'
            ),
            'cxx': (
                '/usr/bin/ccache /home/worker/workspace/build/src/android-ndk/'
                'toolchains/arm-linux-androideabi-4.9/prebuilt/linux-x86_64/'
        ...
        (
            'pub/mobile/candidates/56.0b1-candidates/build1/'
        ...
        'fennec-56.0b1.multi.android-arm.json': {
            ...
            "cc": (
                "/bin/ccache /builds/worker/workspace/build/src/android-ndk/"
                "toolchains/llvm/prebuilt/linux-x86_64/bin/clang "
                "-std=gnu99 --target=i386-linux-android"
            ),
            "cxx": (
                "/bin/ccache /builds/worker/workspace/build/src/android-ndk/"
                "toolchains/llvm/prebuilt/linux-x86_64/bin/clang++ "
                "-std=gnu++11 --target=i386-linux-android"
            ),
            "host_alias": "x86_64-pc-linux-gnu",
            "host_cpu": "x86_64",
            "host_os": "linux-gnu",
        ...
        self.mock_create_record.assert_any_call(
            ...
            data={
                ...
                'build': {
                    ...
                    'cc': (
                        '/usr/bin/ccache /home/worker/workspace/build/src/'
                        'android-ndk/toolchains/arm-linux-androideabi-4.9/'
                        'prebuilt/linux-x86_64/bin/'
        ...
        self.mock_create_record.assert_any_call(
            ...
            data={
                ...
                'build': {
                    ...
                    'as': '$(CC)',
                    'cc': (
                        '/bin/ccache /builds/worker/workspace/build/src/'
                        'android-ndk/toolchains/llvm/prebuilt/linux-x86_64/'
                        'bin/clang -std=gnu99 --target=i386-linux-android'
                    ),
                    'cxx': (
                        '/bin/ccache /builds/worker/workspace/build/src/'
                        'android-ndk/toolchains/llvm/prebuilt/linux-x86_64/'
                        'bin/clang++ -std=gnu++11 --target=i386-linux-android'
                    ),
                    'host': 'x86_64-pc-linux-gnu',
                    'target': 'i386-pc-linux-android',
                    'number': 1
...
class FromNightlyMetadataAndroid(BaseTest):
    remote_content = {
        ...
        # Old-id stuff.
        (
            'pub/mobile/nightly/2017/08/2017-08-02-10-03-02-mozilla-central-'
    ...
    async def test_from_nightly_date_are_ignored(self):
        event = fake_event(
            'pub/mobile/nightly/2017/08/2017-08-01-15-03-46-date-android'
    ...
    async def test_from_nightly_multi_arm(self):
        ...
        self.mock_create_record.assert_any_call(
            ...
            data={
                'id': (
                    'fennec_nightly_2017-08-01-15-03-46_56-0a1_android'
                    '-api-15_multi'
                ),
                'source': {
                    'product': 'fennec',
    ...
    async def test_from_nightly_multi_old_id(self):
        ...
        self.mock_create_record.assert_called_with(
            ...
            data={
                'id': (
                    'fennec_nightly-old-id_2017-08-02-10-03-02_57-0a1_'
                    'android-api-15_multi'
                ),
                'source': {
                    'product': 'fennec',
                    'revision': '52285ea5e54c73d3ed824544cef2ee3f195f05e6',
    ...
    async def test_from_nightly_arm_fetches_other_languages(self):
        ...
        # Note: simulate multi archive is not published yet. Only
        # l10n derivatives
        # (see remote_content)
        assert self.mock_create_record.call_count == 2
        ...
        self.mock_create_record.assert_any_call(
            ...
            data={
                'id': (
                    'fennec_nightly_2017-08-09-10-03-39_57-0a1_'
                    'android-api-15_be'
                ),
                'source': {
                    'product': 'fennec',
...
class FromNightlyArchiveFennec(BaseTest):
    ...
    async def test_from_nightly_archive_linux_metadata_missing(self):
        event = fake_event(
            'pub/mobile/nightly/2017/10/2017-10-29-10-22-14-mozilla-'

...
* `$SERVER/buckets/build-hub/collections/releases/records?_limit=10 <https://kinto-ota.dev.mozaws.net/v1/buckets/build-hub/collections/releases/records?_limit=10>`_
